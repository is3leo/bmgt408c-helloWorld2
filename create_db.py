...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'major_id':3,
            'birth_date': dt.datetime(2005, 6, 1), 'is_honors':1, 'email_address':'rsmith@umd.edu'},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id':6,
         'birth_date': dt.datetime(2004, 3, 24), 'is_honors': 0, 'email_address':'lvmunch@umd.edu'}]
    ...
    for each_student in students:
        ...
        a_student = Student(first_name=each_student["first_name"], last_name=each_student["last_name"],
                            ...
                            is_honors=each_student["is_honors"], email_address=each_student["email_address"])
