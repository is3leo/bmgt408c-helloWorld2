...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'ileo', 'email': 'ileo@terpmail.umd.edu', 'first_name':'Isabelle', 'last_name':'Leo',
            'password': generate_password_hash('isabellepw', method='pbkdf2:sha256'), 'role':'STUDENT'}
    ]
    ...
    students = [
        ...
        {'student_id': '2', 'first_name': 'Isabelle', 'last_name': 'Leo', 'email': 'ileo@terpmail.umd.edu',
         'major_id': 4, 'birth_date': dt.datetime(2004, 6, 10), 'is_honors': 1}
    ]
